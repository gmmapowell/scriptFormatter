package com.gmmapowell.script.modules.output.epub;
...
public class EPubOutputConfigListener implements ConfigListener {
	private ReadConfigState state;
	private VarMap vars = new VarMap();

	public EPubOutputConfigListener(ReadConfigState state) {
		this.state = state;
	}
