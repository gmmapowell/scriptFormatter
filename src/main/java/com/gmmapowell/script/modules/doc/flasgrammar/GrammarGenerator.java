...
public class GrammarGenerator implements ProductionVisitor {
	...
	public GrammarGenerator(Production rule, ConfiguredState state) {
		this.topRule = rule;
		this.grammar = null;
		this.state = state;
	}

	public GrammarGenerator(Grammar grammar, ConfiguredState state) {
		this.topRule = null;
